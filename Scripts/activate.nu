...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Backup-Folder\Masterarbeit_Klemens Lechner\Lechner_thesis'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Backup-Folder\Masterarbeit_Klemens Lechner\Lechner_thesis\Scripts\deactivate.nu'
